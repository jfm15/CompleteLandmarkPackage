...
def alpha_angles(ax, points, color):
    ...
    # left
    ax.plot([left_center[0], left_cam_point[0]], [left_center[1], left_cam_point[1]], color=color)
    ax.plot([left_center[0], left_neck_point[0]], [left_center[1], left_neck_point[1]], color=color)

    # right
    ax.plot([right_center[0], right_cam_point[0]], [right_center[1], right_cam_point[1]], color=color)
    ax.plot([right_center[0], right_neck_point[0]], [right_center[1], right_neck_point[1]], color=color)
...
def lce_angles(ax, points, color):
    ...
    # left
    ax.plot([left_center[0], left_lat_point[0]], [left_center[1], left_lat_point[1]], color=color)
    ax.plot([left_center[0], left_center[0]], [left_center[1], left_center[1] - 50], color=color)

    # right
    ax.plot([right_center[0], right_lat_point[0]], [right_center[1], right_lat_point[1]], color=color)
    ax.plot([right_center[0], right_center[0]], [right_center[1], right_center[1] - 50], color=color)
